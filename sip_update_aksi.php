...
// Nama Penghuni dan Nama Anggota
 ...
 // Menentukan Tanggal Expired
    ...
    if($komplek=="RUSUNAWA"){
	    $thn_akhir=substr($tgl_berlaku,-2)+1; //kalo nambah tahun tinggal ganti angka 3 berarti 3 tahun
    }else{
	    $thn_akhir=substr($tgl_berlaku,-2)+3; //kalo nambah tahun tinggal ganti angka 3 berarti 3 tahun
	}
   	//echo $thn_akhir." ";
...
// Pangkat
 ...
 $perintahhabuspenghuni="DELETE FROM tbl_penghuni WHERE NRP='$nrp_utk_update';";
 $sqlhapus_penghuni=mysql_query($perintahhabuspenghuni,$conn);
			if (!$sqlhapus_penghuni) 
			die ("Proses hapus PENGHUNI gagal 1");

 
$perintahubah_penghuni="INSERT INTO tbl_penghuni
							(NAMA_PENGHUNI, NAMA_ANGGOTA, NRP, JABATAN, SATKER, KODE_STATUS, KODE_KAT, KODE_KORPS, TELEPON, SEWA)
							  VALUES 
							('$nama_penghuni','$nama_anggota','$nrp','$jabatan','$satker','$status','$kode_kat','$kode_korps','$telepon','$sewa');";    
	
	$sqlubah_penghuni=mysql_query($perintahubah_penghuni,$conn);
			if (!$sqlubah_penghuni) 
			die ("Proses UPDATE PENGHUNI gagal 1");

       
	//menambahkan tbl_sip
	
	$nouruttblsip = $_POST['nouruttblsip'];
	//echo $nouruttblsip." ";
	$perintahhapus_sip="DELETE FROM tbl_sip WHERE NO_URUTSIP='$nouruttblsip';";
	$sqlhapus_sip=mysql_query($perintahhapus_sip,$conn);
			if (!$sqlhapus_sip) 
			die ("Proses hapus TBL SIP gagal 1");
	...
	/*$perintahubah_sip = " UPDATE tbl_sip SET 
       ...
       // echo $nosip."  ".$nrp."  ".$id_rumah."  ".$tgl_berlaku."  ".$tgl_expired."  ".$hari_ini."<br>";
        $perintahubah_sip="INSERT INTO tbl_sip (ID_RUMAH, NRP, NO_SIP, NRP_TTD, TGL_BERLAKU, TGL_EXPIRED, LAST_UPDATE)
						 VALUES ('$id_rumah','$nrp','$nosip','10425/P','$tgl_berlaku','$tgl_expired','$hari_ini');";    
	
          
	$sqlubah_sip=mysql_query($perintahubah_sip,$conn);
			if (!$sqlubah_sip) 
			die ("Proses insert TBL SIP  gagal 2");
...
<table style="width: 53%; color: #003300;" align="center">
	...
	<tr>
	  ...
	  <td class="standardteks" style="border: 0px #FFFFFF none; height: 21px; outline-color: #FFFFFF; width: 15px; color:green"></td>
	  <td class="standardteks" style="border: 0px #FFFFFF none; height: 21px; outline-color: #FFFFFF; width: 593px;color:#003300;" colspan="3">
<label id="Label2"><?php echo $alamat;?></label>
		  </td>
	</tr>
	<tr>
	...
	<tr>
		<td style="width: 457px; color:white;height:21px;" class="standardteks" bgcolor="green">
		&nbsp;&nbsp; Jabatan&nbsp;</td>
		<td style="width: 15px" class="standardteks" align="right">:</td>
		<td style="width: 15px" class="standardteks">&nbsp;</td>
		<td style="width: 593px" class="standardteks" colspan="3"><?php 
        if ($jabatan==""){
            ?><font color="red">Jabatan tidak terecord</font> <?php
        }else{
        echo $jabatan;}
        ?>
        </td>
    ...
    <tr>
        ...
        switch ($sewa){
            case "0" :
                $statussewa = "Tidak terecord";
                ?>
                <script type="text/javascript">
                    alert ("Status Sewa belum dipilih, Pilih salah satu BRO....")
                    window.history.back()
                </script>
                <?php
                break ;
            case "1" :
                 $statussewa = "Tidak dikenai / Gratis";
                 break;
            case "2" :
                 $statussewa = "Sudah bayar";
                 break;
            case "3" :
    ...
    ?>
		<table style="width: 53%; height: 40px;" align="center">
			<tr>
				...
				<td style="width: 178px;color:blue;" align="center"><a href="Javascript:buka('<?php echo 'cetakpdf2.php?id_rumah='.$id_rumah.'&&nrp='.$nrp;?>')" style="color:blue">Cetak SIP Tanpa TTD</a>
				<a href="Javascript:buka('<?php echo 'cetakpdf.php?id_rumah='.$id_rumah.'&&nrp='.$nrp;?>')" style="color:blue">Cetak SIP Dengan TTD</a>
				</td>
...
//echo $nrp.'<br>';
	...
	$perintahhapus_keluarga= "DELETE FROM tbl_keluarga WHERE NRP='$nrp_utk_update';";
        
	$sqlhapus_keluarga=mysql_query($perintahhapus_keluarga,$conn);
			if (!$sqlhapus_keluarga) 
			die ("Proses hapus keluarga gagal");
...
$tempatlahir1=$_POST['tempatlahir1'];
$tgllahir1=$_POST['tgllahir1'].$_POST['bulanlahir1'].$_POST['thnlahir1'];
$hubungan1=$_POST['hubungan1'];
$keterangan1=$_POST['ket1'];

if($namakeluarga1<>""){
    $perintahtambah_keluarga= "INSERT INTO tbl_keluarga
                                (NRP, NAMAKELUARGA, GENDER, TEMPATLHR,TGLLAHIR,HUBUNGAN,KET)
                                VALUES 
                                ('$nrp','$namakeluarga1','$gender1','$tempatlahir1','$tgllahir1','$hubungan1','$keterangan1');";
                                 
         
	$sqltambah_keluarga=mysql_query($perintahtambah_keluarga,$conn);
			if (!$sqltambah_keluarga) 
			die ("Proses tambah keluarga gagal 1");
...
$tgllahir2=$_POST['tgllahir2'].$_POST['bulanlahir2'].$_POST['thnlahir2'];
...
if($namakeluarga2<>""){
    $perintahtambah_keluarga= "INSERT INTO tbl_keluarga
                                (NRP, NAMAKELUARGA, GENDER, TEMPATLHR,TGLLAHIR,HUBUNGAN,KET)
                                VALUES 
                                ('$nrp','$namakeluarga2','$gender2','$tempatlahir2','$tgllahir2','$hubungan2','$keterangan2');";
                                 
         
	$sqltambah_keluarga=mysql_query($perintahtambah_keluarga,$conn);
			if (!$sqltambah_keluarga) 
			die ("Proses tambah keluarga gagal 2");
}
...
$tgllahir3=$_POST['tgllahir3'].$_POST['bulanlahir3'].$_POST['thnlahir3'];
$hubungan3=$_POST['hubungan3'];
$keterangan3=$_POST['ket3'];

if($namakeluarga3<>""){
    $perintahtambah_keluarga= "INSERT INTO tbl_keluarga
                                (NRP, NAMAKELUARGA, GENDER, TEMPATLHR,TGLLAHIR,HUBUNGAN,KET)
                                VALUES 
                                ('$nrp','$namakeluarga3','$gender3','$tempatlahir3','$tgllahir3','$hubungan3','$keterangan3');";
                                 
         
	$sqltambah_keluarga=mysql_query($perintahtambah_keluarga,$conn);
			if (!$sqltambah_keluarga) 
			die ("Proses tambah keluarga gagal 3");
}
...
$tgllahir4=$_POST['tgllahir4'].$_POST['bulanlahir4'].$_POST['thnlahir4'];
$hubungan4=$_POST['hubungan4'];
$keterangan4=$_POST['ket4'];

if($namakeluarga4<>""){
    $perintahtambah_keluarga= "INSERT INTO tbl_keluarga
                                (NRP, NAMAKELUARGA, GENDER, TEMPATLHR,TGLLAHIR,HUBUNGAN,KET)
                                VALUES 
                                ('$nrp','$namakeluarga4','$gender4','$tempatlahir4','$tgllahir4','$hubungan4','$keterangan4');";
                                 
         
	$sqltambah_keluarga=mysql_query($perintahtambah_keluarga,$conn);
			if (!$sqltambah_keluarga) 
			die ("Proses tambah keluarga gagal 4");
}
...
$tempatlahir5=$_POST['tempatlahir5'];
$tgllahir5=$_POST['tgllahir5'].$_POST['bulanlahir5'].$_POST['thnlahir5'];
$hubungan5=$_POST['hubungan5'];
$keterangan5=$_POST['ket5'];

if($namakeluarga5<>""){
    $perintahtambah_keluarga= "INSERT INTO tbl_keluarga
                                (NRP, NAMAKELUARGA, GENDER, TEMPATLHR,TGLLAHIR,HUBUNGAN,KET)
                                VALUES 
                                ('$nrp','$namakeluarga5','$gender5','$tempatlahir5','$tgllahir5','$hubungan5','$keterangan5');";
                                 
         
	$sqltambah_keluarga=mysql_query($perintahtambah_keluarga,$conn);
			if (!$sqltambah_keluarga) 
			die ("Proses tambah keluarga gagal 5");
}

//nama keluarga 6

$namakeluarga6=$_POST['namakeluarga6'];
$gender6=$_POST['gender6'];
$tempatlahir6=$_POST['tempatlahir6'];
$tgllahir6=$_POST['tgllahir6'].$_POST['bulanlahir6'].$_POST['thnlahir6'];
$hubungan6=$_POST['hubungan6'];
$keterangan6=$_POST['ket6'];

if($namakeluarga6<>""){
    $perintahtambah_keluarga= "INSERT INTO tbl_keluarga
                                (NRP, NAMAKELUARGA, GENDER, TEMPATLHR,TGLLAHIR,HUBUNGAN,KET)
                                VALUES 
                                ('$nrp','$namakeluarga6','$gender6','$tempatlahir6','$tgllahir6','$hubungan6','$keterangan6');";
                                 
         
	$sqltambah_keluarga=mysql_query($perintahtambah_keluarga,$conn);
			if (!$sqltambah_keluarga) 
			die ("Proses tambah keluarga gagal 6");
}
?>
<table align="center" class="standardteks" style="width: 40%" border="0">
	<tr>
		<td colspan="6" align="center">INFORMASI KELUARGA</td>
	</tr>
	<tr align="center" bgcolor="#CCF2EE">
		<td >NO</td>
		<td >NAMA KELUARGA </td>
		<td >LK/PR</td>
		<td >TEMPAT,<br />
...
?>
	...
	<tr bgcolor="#ABF0FC">
		...
		<td><?php echo $namakeluarga1; ?></td>
		<td align="center"><?php echo $gender1; ?></td>
		<td><?php echo $tempatlahir1.", ".$tgllahir1; ?></td>
...
?>
	...
	<tr bgcolor="#E9FBFE">
		...
		<td><?php echo $namakeluarga2; ?></td>
		<td align="center"><?php echo $gender2; ?></td>
		<td><?php echo $tempatlahir2.", ".$tgllahir2; ?></td>
		<td width="15%" align="center"><?php 
		if($hubungan2=="ak"){
			echo "Anak Kandung";
		}else{
...
?>
	...
	<tr bgcolor="#ABF0FC">
		...
		<td><?php echo $namakeluarga3; ?></td>
		<td align="center"><?php echo $gender3; ?></td>
		<td><?php echo $tempatlahir3.", ".$tgllahir3; ?></td>
		<td width="15%" align="center"><?php 
		if($hubungan3=="ak"){
			echo "Anak Kandung";
		}else{
...
?>
	<tr bgcolor="#E9FBFE">
		...
		<td><?php echo $namakeluarga4; ?></td>
		<td align="center"><?php echo $gender4; ?></td>
		<td><?php echo $tempatlahir4.", ".$tgllahir4; ?></td>
		<td width="15%" align="center"><?php
		if($hubungan4=="ak"){
			echo "Anak Kandung";
		}else{
...
?>
	<tr bgcolor="#ABF0FC">
		...
		<td><?php echo $namakeluarga5; ?></td>
		<td align="center"><?php echo $gender5; ?></td>
		<td><?php echo $tempatlahir5.", ".$tgllahir5; ?></td>
		<td width="15%" align="center"><?php
		if($hubungan5=="ak"){
			echo "Anak Kandung";
		}else{
...
?>
	<tr bgcolor="#ABF0FC">
		...
		<td><?php echo $namakeluarga6; ?></td>
		<td align="center"><?php echo $gender6; ?></td>
		<td><?php echo $tempatlahir6.", ".$tgllahir6; ?></td>
		<td width="15%" align="center"><?php
		if($hubungan6=="ak"){
			echo "Anak Kandung";
		}else{
