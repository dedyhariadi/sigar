...
<script type="text/javascript" language="javascript">
	...
	function buka(){
		...
		location.href="rh_list.php?pilihankomplek="+pilihankmplk;    
        }else{
       		location.href="rh_history.php?id_rumah="+idrumah;    
        }
	}
...
<form name="formkomplek" action="rh_history.php" method="get">
...
&nbsp;</p>
<p align="left" style="font-family:'Berlin Sans FB'; margin-left:469px; width: 282px; height: 19px; text-align: center;"><a href="Javascript:buka()">Cetak Detail Rumah</a></p>
</form>
</body>
