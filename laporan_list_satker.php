...
<?php 
	...
	$perintahkomplekk="SELECT * FROM TBL_PENGHUNI WHERE SATKER LIKE '%$pilihankomplek%';";
...
<table style="width: 100%" border="0" id="tabelku" align="center" class="standardteks">
	...
	<tr style="text-align: center; color: #FFFFFF; background-color: #333399;">
		...
		<td style="width: 15%;" rowspan="2">KOMPLEK&nbsp;</td>
	...
	<tr style="text-align: center; color: #FFFFFF; background-color: #333399;">
		...
		<?php 
			...
			$perintah_laporan="select a.*,b.*,c.*, d.* from tbl_rumah a,tbl_sip b, tbl_penghuni c, tbl_komplek d 
								where a.id_rumah=b.id_rumah and b.nrp=c.nrp and a.id_komplek=d.id_komplek and c.SATKER like '%$pilihankomplek%'
								order by d.id_komplek;";
				...
				$tgl_sip=substr($hasil['NO_SIP'],-6);
					?>
							...
							<tr style="height: 30px;" class="tulisantabel" onmouseover="ubahwarna('<?php echo ($x+1);?>')" id="bariss" onmouseout="balikwarna('<?php echo ($x+1);?>')">
								...
								<td style="text-align: left; width: 15%;">&nbsp;<?php echo $hasil['KOMPLEK'];	?></td>
