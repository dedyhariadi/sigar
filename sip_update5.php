...
<table style="width: 60%; " align="center" border="0">
		...
		<?php
			...
			while ($hasil_status = mysql_fetch_array($sql_status)) 
				...
				if ($hasil_status['KODE_STATUS']==$idstatus)
					{
						?>
							<input  onfocus="javascript:kembali();"   onclick="hideanggota(<?php echo $hasil_status['KODE_STATUS'];?>)" name="status" type="radio" value="<?php echo $hasil_status['KODE_STATUS'];?>1"  CHECKED="checked"/>&nbsp;<?php echo $hasil_status['STATUS'];?>&nbsp;&nbsp;&nbsp;&nbsp;
						<?php
	
					}else{
						?>
						<input  onfocus="javascript:kembali();"  name="status" type="radio" onclick="hideanggota(<?php echo $hasil_status['KODE_STATUS'];?>)"  value="<?php echo $hasil_status['KODE_STATUS'];?>2"/>&nbsp;<?php echo $hasil_status['STATUS'];?>&nbsp;&nbsp;&nbsp;&nbsp;
						<?php
					}
				} 
			if($idstatus<4) 
	...
	<tr bgcolor="#E1FFFF">
		<td style="width: 19%" class="standardteks">&nbsp;</td>
		<td style="width: 19px" class="standardteks">&nbsp;</td>
		<td style="width: 593px" class="standardteks">&nbsp;</td>
	</tr>
	</table>
	<br/>
	<table style="width: 74%; " align="center" border="0">
	<tr bgcolor="#EEFDF3">
		<td style="height: 26px" class="auto-style2" colspan="6">INFORMASI&nbsp; KELUARGA</td>
	</tr>`

	<tr bgcolor="#CEF7D6">
		<td class="auto-style3" style="width: 215px">NAMA KELUARGA</td>
		<td class="auto-style3">GENDER</td>
		<td class="auto-style3">TEMPAT LAHIR</td>
		<td class="auto-style3">TGL LAHIR</td>
		<td style="width: 75px" class="auto-style3">HUBUNGAN KELUARGA</td>
		<td style="width: 124px" class="auto-style3">KET</td>
	</tr>
	<?php
	$prnth="SELECT * FROM tbl_keluarga WHERE NRP='$nrp';";
	...
	<tr bgcolor=#F1E0DA>
		...
		<input name="namakeluarga1" type="text"  class="standardteks" style="width: 224px"  maxlength="27" size="27"/></td>
		<td><select name="gender1">
		<option value="Lk">Pria</option>
		<option selected="selected" value="Pr">Wanita</option>
		</select>&nbsp;</td>
		<td><input name="tempatlahir1" type="text" />&nbsp;</td>
		...
		</select><input name="thnlahir1" size="4" type="text" maxlength="4" style="height: 22px" /></td>
		<td style="width: 75px"><select name="hubungan1">
		<option>Istri</option>
		<option>Suami</option>
		...
		<input name="ket1" type="text" style="width: 65px" />&nbsp;</td>
	</tr>
	<?php}?>
	<tr bgcolor=#F1E0DA>
		<td style="width: 215px">
		<input name="namakeluarga2" type="text"  class="standardteks" style="width: 224px"  maxlength="27" size="27"/></td>
		<td><select name="gender2">
		<option selected="selected" value="Lk">Pria</option>
		<option value="Pr">Wanita</option>
		</select>&nbsp;</td>
		<td><input name="tempatlahir2" type="text" />&nbsp;</td>
		...
		</select><input name="thnlahir2" size="4" type="text" maxlength="4" /></td>
		<td style="width: 75px"><select name="hubungan2">
		<option>Anak Kandung</option>
		<option>Istri</option>
		<option>Anak Tiri</option>
		</select></td>
		<td style="width: 124px">
		<input name="ket2" type="text" style="width: 65px" />&nbsp;</td>
	</tr>
<tr bgcolor=#F1E0DA>
		<td style="width: 215px">
		<input name="namakeluarga3" type="text"  class="standardteks" style="width: 224px"  maxlength="27" size="27"/></td>
		<td><select name="gender3">
		<option selected="selected" value="Lk">Pria</option>
		<option value="Pr">Wanita</option>
		</select>&nbsp;</td>
		<td><input name="tempatlahir3" type="text" />&nbsp;</td>
		...
		</select><input name="thnlahir3" size="4" type="text" maxlength="4" /></td>
		<td style="width: 75px"><select name="hubungan3">
		<option>Anak Kandung</option>
		<option>Istri</option>
		<option>Anak Tiri</option>
		</select></td>
		<td style="width: 124px">
		<input name="ket3" type="text" size="20" style="width: 63px" /></td>
	</tr>
<tr bgcolor=#F1E0DA>
		<td style="width: 215px">
		<input name="namakeluarga4" type="text"  class="standardteks" style="width: 224px"  maxlength="27" size="27"/></td>
		<td><select name="gender4">
		<option selected="selected" value="Lk">Pria</option>
		<option value="Pr">Wanita</option>
		</select>&nbsp;</td>
		<td><input name="tempatlahir4" type="text" />&nbsp;</td>
		...
		</select><input name="thnlahir4" size="4" type="text" maxlength="4" /></td>
		<td style="width: 75px"><select name="hubungan4">
		<option>Anak Kandung</option>
		<option>Istri</option>
		<option>Anak Tiri</option>
		</select></td>
		<td style="width: 124px">
		<input name="ket4" type="text" size="20" style="width: 63px" /></td>
	</tr>
<tr bgcolor=#F1E0DA>
		<td style="width: 215px">
		<input name="namakeluarga5" type="text"  class="standardteks" style="width: 224px"  maxlength="27" size="27"/></td>
		<td><select name="gender5">
		<option selected="selected" value="Lk">Pria</option>
		<option value="Pr">Wanita</option>
		</select>&nbsp;</td>
		<td><input name="tempatlahir5" type="text" />&nbsp;</td>
		...
		</select><input name="thnlahir5" size="4" type="text" maxlength="4" /></td>
		<td style="width: 75px"><select name="hubungan5">
		<option>Anak Kandung</option>
		<option>Istri</option>
		<option>Anak Tiri</option>
		</select></td>
		<td style="width: 124px">
		<input name="ket5" type="text" style="width: 65px" />&nbsp;</td>
	</tr>
