...
$pdf->Cell(50,4,'KOMANDO ARMADA II',0,1,'C');
$pdf->Cell(50,4,'PANGKALAN UTAMA TNI AL V',0,1,'C');
$pdf->Ln();
//$pdf->Cell(70,4,'',1,'R');
$pdf->Line(13,18,61,18);
$pdf->Ln();
...
$pdf->Cell(65,4,'',0,0,'L');
//$pdf->Image('foto/19592P.jpg',37,$fotolokasi,38,55);
//$pdf->MultiCell(67,4,'mewakili,',0,'C');
//$pdf->Ln();
$pdf->Ln();
$yy=$pdf->GetY();
$pdf->Image('gambar/ttdwadan.png',90,$yy-2,40,18);
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();
$pdf->Cell(65,4,'',0,0,'L');
$pdf->MultiCell(67,4,'C.T.O. Sinaga',0,'C');
$pdf->Cell(65,4,'',0,0,'L');
$pdf->MultiCell(67,4,'Kolonel Marinir NRP 10425/P',0,'C');
