...
<p class="judul">SURAT IZIN PENGHUNIAN RUMNEG TNI AL<strong><br /></strong><span lang="id">=============================================</span></p>
...
<table style="width: 90%; margin-left: 142px;" align="center" border="0">
	<tr>
		<td style="width: 15%; height: 26px" class="standardteks">Kode Rumah</td>
	...
	<tr>
		<td style="width: 15%; height: 4px;" class="standardteks">Alamat</td>
	...
	<tr>
		<td style="width: 15%; height: 26px" class="standardteks">Komplek</td>
		<td style="height: 26px; width: 1px;" class="standardteks">:</td>
	...
	<tr>
		<td style="width: 15%" class="style29" >&nbsp;</td>
		<td style="width: 1px" class="style4">&nbsp;</td>
		<td class="standardteks" style="width: 593px;color:blue">INFORMASI SIP </td>
	</tr>
	<tr>
        
		<td style="width: 15%" class="standardteks">Nomor S I P</td>
		<td style="width: 1px" class="standardteks">:</td>
		<td style="width: 593px"><input type="text" class="standardteks" name="nosip" value="<?php echo $hasil['NO_SIP'];?>"/></td>
	</tr>
	<tr>
	    <?php
		...
		<td style="width: 15%" class="standardteks">Nama Penghuni</td>
		<td style="width: 1px" class="standardteks">:</td>
	...
	<tr>
		<td style="width: 15%" class="standardteks">Status</td>
		<td style="width: 1px" class="standardteks">:</td>
	...
	<tr>
		<td style="width: 15%; height: 23px" class="standardteks">Pangkat / 
		Golongan</td>
	...
	<tr>
		<td style="width: 15%; height: 23px" class="standardteks">NRP / NIP</td>
		<td style="height: 23px; width: 1px;" class="standardteks">:</td>
	...
	<tr>
		<td style="width: 15%" class="standardteks">Satker</td>
		<td style="width: 1px" class="standardteks">:</td>
	...
	<tr>
		<td style="width: 15%" class="standardteks">Tanggal Berlaku</td>
		<td style="width: 1px" class="standardteks">:</td>
		<?php 
	...
	<tr>
		<td style="width: 15%" class="standardteks">Foto Penghuni</td>
		<td style="width: 1px" class="standardteks">:</td>
	...
	<tr>
		<td style="width: 15%" class="standardteks" >&nbsp;</td>
		<td style="width: 1px" class="style4">&nbsp;</td>
		<td class="style16" style="width: 593px"><span lang="id">
		-----------------------------------</span></td>
	</tr>
...
<div class="standardteks" align="left" style="margin-left:300px">
