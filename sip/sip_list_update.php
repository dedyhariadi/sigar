...
<p class="standardteks" align="center">Komplek :&nbsp;<select name="pilihankomplek" style="width: 146px" onchange="jumprumah()" id="kmplk" class="standardteks">
		<?php
		...
		<?php 
			...
			while ($hasil = mysql_fetch_array($sql)) 
				...
				$tgl_sip=substr($hasil['NO_SIP'],-6);
					...
					?>
					<form>
							<tr style="height: 30px;" class="tulisantabel" onmouseover="ubahwarna('<?php echo $x;?>')" id="bariss" onmouseout="balikwarna('<?php echo $x;?>')">
