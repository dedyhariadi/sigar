...
<table style="width: 80%" align="center" border="0" id="tabelku">
	...
	<tr style="text-align: center; color: #FFFFFF; background-color: #333399;font-family:'Segoe UI Semibold';font-size:large">
		...
		RMH</td>
		<td style="width: 112px; height: 63px; font-family: 'Segoe UI Semibold'; font-size: large;">NAMA</td>
		<td height: 63px;" style="height: 63px; width: 17%;">PANGKAT, KORPS</td>
				...
				$tgl_sip=substr($hasil['NO_SIP'],-6);
					...
					<form>
							<tr class="tulisantabel" onmouseover="ubahwarna('<?php echo $x;?>')" id="bariss" onmouseout="balikwarna('<?php echo $x;?>')">
								...
								<td style="width: 34px; text-align: center;"><a href="updatermh.php?id_rumah=<?php	echo $hasil['ID_RUMAH'];?>&tgl_expired=<?php echo $tgl_expired?>"><?php echo $hasil['ID_RUMAH'];?></a></td>
								<?php 		
								...
								?>
								<td style="width: 112px" ><?php	echo $hasil_penghuni['NAMA_PENGHUNI'];	?></td>
								<?php
								//cari pangkat
								...
								?>
								<td style="width: 17%" ><?php echo $hasil_pangkat['Pangkat']. " ".$hasil_korps['KORPS'];?></td>
