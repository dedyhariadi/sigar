...
// Nomor SIP
   ...
   if ($nosip==""){
     if(substr($nosipasli,-4)=="9999"){
       ...
       $perintah_nosip="SELECT * FROM tbl_sip WHERE NO_SIP like '%999999';";
		    $sql_nosip=mysql_query($perintah_nosip,$conn);
        $jmlnosip_temp=mysql_num_rows($sql_nosip);
        $nosip=($jmlnosip_temp+1)."/999999";
        }
   }
...
// Nama Penghuni dan Nama Anggota
 ...
 // Menentukan Tanggal Expired
	...
	$tgl_berlaku=$_POST['tanggal_berlaku'].$_POST['bulan_berlaku'].$_POST['tahun_berlaku'];
