...
<table style="width: 70%; height: 67px; margin-left: 150px;" border="0" id="tabela" class="standardteks" >
	...
	<?php 
		...
		{	
			...
			$perintah_rmh= "select * from tbl_rumah where ID_RUMAH like '$kodekomplek%';";
	...
	<tr onmouseover="ubahwarna('<?php echo $hasil_komplek['ID_KOMPLEK'];?>')" onmouseout="balikwarna('<?php echo $hasil_komplek['ID_KOMPLEK'];?>')">
		...
		<td style="width: 17px; height: 30px; padding-right:17px;" align="right"><a id="aktif<?php ?>" href="rekapitulasi_list.php?pilihankomplek=<?php echo $hasil_komplek['ID_KOMPLEK'];?>&&status=<?php echo "1";?>"></a></td>
		...
		<td style="width: 17px; height: 30px; padding-right:17px;" align="right"><a id="jml_perkomplek<?php echo $s; ?>" href="rekapitulasi_list.php?pilihankomplek=<?php echo $hasil_komplek['ID_KOMPLEK'];?>&&status=<?php echo "0";?>"><?php echo $s." Orang";?></a></td>
	</tr>
	<?php 
          $jml_all=$jml_all+$s;  
	}
