...
//		var formm=document.getElementById("formid");
	...
	//	var pilihan = tabell.rows[bariske].selekaksi[bariske].options[tabell.rows[bariske].selekaksi[bariske].selectedIndex].value;
	}	
				...
				{ 
					...
					<form>
							<tr class="tulisantabel" onmouseover="ubahwarna('<?php echo $x;?>')" id="bariss" onmouseout="balikwarna('<?php echo $x;?>')">
								...
								<td style="width: 34px; text-align: center;"><?php	echo $hasil['ID_RUMAH'];	?></td>
								<td style="width: 200px" ><?php	echo $hasil['NAMA_PENGHUNI'];	?></td>
								<td width="14%" ><?php echo $hasil['Pangkat']. " ".$hasil['KORPS'];?></td>
								<td style="width: 131px; text-align: center;" ><?php	
								...
								<td width="5%" style="text-align: center"><?php echo $hasil['STATUS'];	?></td>
