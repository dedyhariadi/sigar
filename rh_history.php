...
<table style="width: 80%; color: #003300; margin-bottom: 0px;" align="center" border="0">
	...
	<tr>
		...
		<td class="standardteks" style="width: 7%; color:blue">
		&nbsp;</td>
		<td class="standardteks" align="center" bgcolor="#EAD5FF" colspan="3">
		PEJABAT TTD</td>
	</tr>
	<tr>
		...
		<td style="width: 11%; color:black;height:21px;" class="standardteks" bgcolor="#EAD5FF">&nbsp;&nbsp;&nbsp;Nama</td>
		<td style="width: 1%" align="center" class="standardteks" bgcolor="#EAD5FF"><span lang="id">:</span></td>
		<td class="standardteks" style="width: 21%" bgcolor="#EAD5FF">&nbsp;
		<?php 
			$nrp_pejabat=$hasil_sip['NRP_TTD'];
			 
			$prnthpejabat="SELECT * FROM TBL_PEJABAT WHERE NRP_TTD='$nrp_pejabat';";
			$sqlpejabat=mysql_query($prnthpejabat,$conn);
				if (! $sqlpejabat) 
				die ("Perintah pejabat gagal");
			
			$hasil_pejabat = mysql_fetch_array($sqlpejabat);
			
			echo $hasil_pejabat['NAMA_TTD'];
		?>
		</td>
	</tr>
	<tr>
		...
		<td class="standardteks" style="width: 7%">&nbsp;</td>
		<td style="width: 11%; color:black;height:21px;" class="standardteks" bgcolor="#EAD5FF">&nbsp;&nbsp;&nbsp;Pangkat, 
		Korps</td>
		<td style="width: 1%" align="center" class="standardteks" bgcolor="#EAD5FF"><span lang="id">:</span></td>
		<td class="standardteks" style="width: 21%" bgcolor="#EAD5FF">&nbsp;&nbsp;<?php
        
        $kode_kat=$hasil_pejabat['PNGKT_TTD'];	
			$prnth_kat="SELECT * FROM TBL_PANGKAT where Kode_kat='$kode_kat'";
			$sql_kat=mysql_query($prnth_kat,$conn);
				if (! $sql_kat) 
				die ("Perintah Pangkat gagal");
			...
			$kode_korps=$hasil_pejabat['KORPS_TTD'];
			$prnth="SELECT * FROM TBL_KORPS where KODE_KORPS='$kode_korps';";
			$sql=mysql_query($prnth,$conn);
				if (! $sql) 
				die ("Perintah gagal");
	...
	<tr>
		...
		echo $tanggal." ".$bulan." ".$tahun;?></td>
		<td class="standardteks" style="width: 7%">&nbsp;</td>
		<td style="width: 11%; color:black;height:21px;" class="standardteks" bgcolor="#EAD5FF">&nbsp;&nbsp;&nbsp;NRP</td>
		<td style="width: 1%" align="center" class="standardteks" bgcolor="#EAD5FF"><span lang="id">:</span></td>
		<td class="standardteks" style="width: 21%" bgcolor="#EAD5FF">&nbsp;&nbsp;<?php echo $hasil_pejabat['NRP_TTD'];?>&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="standardteks" style="width: 7%">&nbsp;</td>
		<td style="width: 11%; color:black;height:21px;" class="standardteks" bgcolor="#EAD5FF">&nbsp;&nbsp;&nbsp;Jabatan</td>
		<td style="width: 1%" align="center" class="standardteks" bgcolor="#EAD5FF"><span lang="id">:</span></td>
		<td class="standardteks" style="width: 21%" bgcolor="#EAD5FF">&nbsp;&nbsp;<?php echo $hasil_pejabat['JBTN_TTD'];?></td>
	</tr>
	<tr>
		...
		<table style="width: 53%; height: 22px;" align="center">
			<tr>
				...
				<td width="50%" align="center" class="standardteks">SIP (<a href="Javascript:buka('<?php echo 'cetakpdf.php?id_rumah='.$id_rumah.'&&nrp='.$nrp?>')" style="color:#660066">
				Dengan TTD</a> / <a href="Javascript:buka('<?php echo 'cetakpdf2.php?id_rumah='.$id_rumah.'&&nrp='.$nrp?>')" style="color:#660066">
				Tanpa TTD</a> )</td>
