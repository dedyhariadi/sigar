...
?>
<p class="judul" style="color:#400080 ;">DAFTAR PENGHUNI RUMAH NEGARA<br />
</p>

<p class="standardteks" align="center" style="color: #400080;">Komplek :&nbsp;<select name="pilihankomplek" style="width: 146px;color: #400080;" onchange="jumprumah()" id="kmplk" class="standardteks">
	...
	<tr style="text-align: center; color: black; background-color:#DDBBFF;">
		...
		<?php 
            ...
            $prnth="SELECT A.*,B.*
             		 ...
             		 AND B.ID_KOMPLEK='$komplek' order by B.NO_URUTRMH;";
				...
				$tgl_berlaku=$hasil['TGL_BERLAKU'];
                    ...
                    <?php 		
                            ...
                            ?>
								...
								<td style="width: 34px; text-align: center;"><a href="sip_update.php?id_rumah=<?php	echo $hasil['ID_RUMAH'];?>&tgl_expired=<?php echo $tgl_expired?>"><?php echo $hasil['ID_RUMAH'];?></a></td>
