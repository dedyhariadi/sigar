...
<table style="width: 70%; height: 67px; margin-left: 150px;" border="0" id="tabela" class="standardteks" >
	...
	<tr onmouseover="ubahwarna('<?php echo $hasil_komplek['ID_KOMPLEK'];?>')" onmouseout="balikwarna('<?php echo $hasil_komplek['ID_KOMPLEK'];?>')">
		...
		<td style="width: 17px; height: 30px; padding-right:17px;" align="right"><a id="aktif<?php $s=$s+1;echo $s; ?>" href="rekapitulasi_list.php?pilihankomplek=<?php echo $hasil_komplek['ID_KOMPLEK'];?>&&status=<?php echo "1";?>"><?php echo $jmlaktif;?></a></td>
