...
$pdf->Ln();
$pdf->Ln();
$pdf->Cell(132,4,'SURAT IZIN PENGHUNIAN RUSUNAWA',0,1,'C');
if($nosipcetak<>""){
...
$pdf->Cell(6,4,'',0,0,'L');
$pdf->MultiCell(126,4,'a.  SIP ini berlaku dan sah apabila ditandatangani oleh pejabat yang diberi wewenang dalam penerbitan SIP rumah susun sewa negara.',0,'J');
$pdf->Ln();
$pdf->Cell(6,4,'',0,0,'L');
$pdf->MultiCell(126,4,'b.  SIP ini tidak berlaku untuk orang/anggota lain kecuali yang ditunjuk dalam surat izin ini.',0,'J');
$pdf->Ln();
$pdf->Cell(6,4,'',0,0,'L');
$pdf->MultiCell(126,4,'c.  Masa berlaku SIP satu tahun.',0,'J');
...
$pdf->Ln();
$pdf->Cell(65,4,'',0,0,'L');
$pdf->MultiCell(67,4,'Bambang Sutrisno',0,'C');
$pdf->Cell(65,4,'',0,0,'L');
$pdf->MultiCell(67,4,'Kolonel Marinir NRP 9242/P',0,'C');
