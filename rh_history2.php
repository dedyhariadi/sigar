	...
	<tr>
		...
		<table style="width: 53%; height: 22px;" align="center">
			<tr>
				...
				<td width="50%" align="center" class="standardteks">SIP (<a href="('<?php echo 'cetakpdf2.php?id_rumah='.$id_rumah.'&&nrp='.$nrp?>')" style="color:#660066">
				Hal. Depan</a> / <a href="javascript:buka('<?php echo 'sip_cetak2.php?id_rumah='.$id_rumah?>')" style="color:#660066">
				Hal. Belakang</a> )</td>
