...
<script type="text/javascript" language="javascript">
	function jumprumah(){
		...
		location.href="masalah_tdksesuai_list.php?pilihankomplek="+pilihankmplk;
	}
...
?>
<p class="judul">DAFTAR RUMAH NEGARA <br />YANG TIDAK SESUAI PERUNTUKANNYA<br /><span lang="id">========================================</span></p>

<p class="standardteks" align="center">Jumlah Rumneg tidak sesuai peruntukannya di Komplek :&nbsp;<select name="pilihankomplek" style="width: 146px" onchange="jumprumah()" id="kmplk" class="standardteks">
		<?php
	...
	$prnth="SELECT A.*, B.*, C.*
 	 ...
 	 WHERE A.KODE_MASALAH IS NOT NULL
	 AND A.NRP=B.NRP
				...
				$tgl_sip=substr($hasil_sip['NO_SIP'],-6);
					...
					<form>
							<tr class="tulisantabel" onmouseover="ubahwarna('<?php echo $x;?>')" id="bariss" onmouseout="balikwarna('<?php echo $x;?>')">
								...
								<td style="width: 34px; text-align: center;"><a href="sip_perpanjang.php?id_rumah=<?php	echo $hasil['ID_RUMAH'];?>&tgl_expired=<?php echo $tgl_expired?>"><?php echo $koderumah;?></a></td>
